    ...
    async loadSensors(url) {
        await fetch(url).then(async (res) => {
            ...
            response.forEach(sensor => {
                if (sensor.type === "temperature" || sensor.type === "humidity" || sensor.type === "pressure") {
                    let sensorData = new Sensor(sensor.id, sensor.name, sensor.type, sensor.value, sensor.unit , sensor.updated_at);
